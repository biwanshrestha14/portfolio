        ...
        <section className="profile flex flex-col lg:flex-row overflow-hidden">
            <div className="lol skills w-full md:w-[50%]">
                <div className="flex space-x-4 items-center px-4 md:space-x-4 ">
                    ...
                    <div className="flex flex-col leading-8 text-(--text)">
                ...
                <div className="mt-8 px-4">
                    <h1 className="text-3xl font-bold text-center text-(--text) mb-8 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                        🛠️ Tech Stack
                    </h1>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="relative">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-(--text) tracking-wide">Proficient</h2>
                                    ...
                                    <div key={index} className="group relative">
                                        <div className="relative overflow-hidden bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 h-32 flex flex-col items-center justify-center transition-all duration-300 hover:scale-105 hover:bg-white/10 hover:border-green-500/30 hover:shadow-xl hover:shadow-green-500/20">
                                            ...
                                            <img
                                                ...
                                                alt={tech.name}
                                            />
                                            <h3 className="text-xs font-semibold text-(--text) text-center leading-tight">{tech.name}</h3>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="relative">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-(--text) tracking-wide">Intermediate</h2>
                        ...
                        <div className="relative">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-(--text) tracking-wide">Beginner</h2>
            ...
            <div className="lol about mt-10 m-auto px-10 lg:w-[40%] relative">
                <h1 className="text-4xl text-(--salmon) text-center">About Me</h1>
                <p className="text-xl text-(--text) mt-5 lg:text-3xl">
                    Hi, I'm Biwan—a third-year CSIT student at Tribhuvan University with a passion for crafting seamless,
                    user-friendly digital experiences. As a front-end developer, I'm skilled in HTML, CSS, JavaScript, and React,
                    building intuitive and responsive interfaces that bring ideas to life. Recently, I've dived into back-end
                    development with Node.js, expanding my toolkit to create full-stack solutions that connect the dots between
                    design and functionality. I'm always eager to explore new tech, stay ahead of trends, and collaborate on
                    innovative projects.
                </p>
                <ul>
                    <li className="text-sm lg:text-xl">
                        <span className="text-(--primary)">Profile:</span>
                        <span className="text-(--text)"> Full-Stack Developer (Backend Focus)</span>
                    </li>
                    <li className="text-sm lg:text-xl">
                        <span className="text-(--primary)">Domain:</span>
                        <span className="text-(--text)">Web Development & Backend Engineering</span>
                    </li>
                    <li className="text-sm lg:text-xl">
                        <span className="text-(--primary)">Education:</span>
                        <span className="text-(--text)">
                            {" "}
                            Bachelor of Science in Computer Science and Information Technology (3rd Year)
                        </span>
                    </li>
                    <li className="text-sm lg:text-xl">
                        <span className="text-(--primary)">Language:</span>
                        <span className="text-(--text)"> English, Hindi, Nepali</span>
                    </li>
                    <li className="text-sm lg:text-xl">
                        <span className="text-(--primary)">Other Skills:</span>
                        <span className="text-(--text)">
                            {" "}
                    ...
                    <li id="resume" className="text-sm lg:text-xl">
